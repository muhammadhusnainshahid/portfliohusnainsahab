...
//               description="Comprehensive study of information technology fundamentals including software development, database systems, networking, and cybersecurity."
...
//               description="Immersive program focused on full-stack web development using MongoDB, Express.js, React.js, and Node.js."
//               location="Remote"
//               years="2024"
//               gpa="Outstanding"
//               status="Certified"
...
//               <div
//                 key={i}
//                 className="bg-white p-4 rounded-lg shadow flex flex-col items-center text-center space-y-3 transform transition-all duration-300 hover:-translate-y-1 hover:shadow-md"
//               >
//                 <div>{cert.logo}</div>
    ...
    >
      ...
      <AnimatePresence mode="wait">
        {activeTab === "formal" ? (
          ...
          >
            <EduCard
              ...
              courses={[
                ...
                "Mobile Programming",
                "Web Development",
                "Database Systems", // <-- Added comma here
              ]}
              achievements={[
                "Dean's List for 6 Semesters",
                "Capstone Project Award",
          ...
          >
            {[
              { logo: <FaFacebookF className="bg-[#1877F2] w-8 h-8 rounded-full p-1 text-white" />, title: "Meta Front-End Developer", provider: "Coursera", year: "2024" },
              { logo: <FaGoogle className="bg-[#DB4437] w-8 h-8 rounded-full p-1 text-white" />, title: "Google UX Design", provider: "Coursera", year: "2023" },
              { logo: <FaReact className="bg-[#5d068f] w-8 h-8 rounded-full p-1 text-white" />, title: "React + TypeScript", provider: "Udemy", year: "2022" },
              { logo: <FaFreeCodeCamp className="bg-[#0e7760] w-8 h-8 rounded-full p-1 text-white" />, title: "Responsive Web Design", provider: "freeCodeCamp", year: "2021" },
              { logo: <FaAws className="bg-[#FF9900] w-8 h-8 rounded-full p-1 text-white" />, title: "AWS Cloud Practitioner", provider: "Amazon", year: "2024" },
              { logo: <FaMicrosoft className="bg-[#0078D4] w-8 h-8 rounded-full p-1 text-white" />, title: "Microsoft Azure Fundamentals", provider: "Microsoft", year: "2023" },
              { logo: <FaLinux className="bg-[#FCC624] w-8 h-8 rounded-full p-1 text-black" />, title: "Linux for Developers", provider: "Linux Foundation", year: "2022" },
              { logo: <FaGraduationCap className="bg-[#2A73CC] w-8 h-8 rounded-full p-1 text-white" />, title: "Foundations of User Experience (UX)", provider: "Coursera", year: "2021" },
            ].map((cert, i) => (
              <div
                key={i}
                className="bg-white p-4 rounded-lg shadow flex flex-col items-center text-center space-y-3 transform transition-all duration-300 hover:-translate-y-1 hover:shadow-md"
